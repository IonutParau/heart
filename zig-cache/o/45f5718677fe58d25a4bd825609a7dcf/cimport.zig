...
pub const LUAI_TOSTRAUX = @compileError("unable to translate C expr: unexpected token '#'"); // /home/ionut/workspace/Development/Zig/heart/include/lua/lua.h:498:9
pub const luaL_newlibtable = @compileError("unable to translate C expr: unexpected token '('"); // /home/ionut/workspace/Development/Zig/heart/include/lua/lauxlib.h:127:9
pub const luaL_addchar = @compileError("TODO postfix inc/dec expr"); // /home/ionut/workspace/Development/Zig/heart/include/lua/lauxlib.h:207:9
pub const luaL_addsize = @compileError("unable to translate C expr: expected ')' instead got '+='"); // /home/ionut/workspace/Development/Zig/heart/include/lua/lauxlib.h:211:9
pub const luaL_buffsub = @compileError("unable to translate C expr: expected ')' instead got '-='"); // /home/ionut/workspace/Development/Zig/heart/include/lua/lauxlib.h:213:9
...
pub const LUA_VERSION_MINOR_N = @as(c_int, 4);
pub const LUA_VERSION_RELEASE_N = @as(c_int, 6);
