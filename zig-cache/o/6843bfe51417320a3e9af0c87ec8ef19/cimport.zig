...
pub extern fn lua_pushextlstring(L: ?*lua_State, s: [*c]const u8, len: usize, falloc: lua_Alloc, ud: ?*anyopaque) [*c]const u8;
...
pub extern fn luaL_openselectedlibs(L: ?*lua_State, what: c_int) void;
...
pub const LUA_API = @compileError("unable to translate C expr: unexpected token 'extern'"); // /home/ionut/workspace/Development/Zig/heart/include/lua/luaconf.h:297:9
pub const LUAI_FUNC = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // /home/ionut/workspace/Development/Zig/heart/include/lua/luaconf.h:325:9
pub const l_floor = @compileError("unable to translate macro: undefined identifier `floor`"); // /home/ionut/workspace/Development/Zig/heart/include/lua/luaconf.h:418:9
pub const lua_numbertointeger = @compileError("unable to translate C expr: expected ')' instead got '='"); // /home/ionut/workspace/Development/Zig/heart/include/lua/luaconf.h:432:9
pub const l_floatatt = @compileError("unable to translate macro: undefined identifier `DBL_`"); // /home/ionut/workspace/Development/Zig/heart/include/lua/luaconf.h:475:9
pub const lua_str2number = @compileError("unable to translate macro: undefined identifier `strtod`"); // /home/ionut/workspace/Development/Zig/heart/include/lua/luaconf.h:484:9
...
pub const lua_getlocaledecpoint = @compileError("unable to translate macro: undefined identifier `localeconv`"); // /home/ionut/workspace/Development/Zig/heart/include/lua/luaconf.h:671:9
pub const LUAI_MAXALIGN = @compileError("unable to translate macro: undefined identifier `n`"); // /home/ionut/workspace/Development/Zig/heart/include/lua/luaconf.h:782:9
pub const LUAI_TOSTRAUX = @compileError("unable to translate C expr: unexpected token '#'"); // /home/ionut/workspace/Development/Zig/heart/include/lua/lua.h:518:9
...
pub const luaL_newlibtable = @compileError("unable to translate C expr: unexpected token '('"); // /home/ionut/workspace/Development/Zig/heart/include/lua/lauxlib.h:129:9
pub const luaL_addchar = @compileError("TODO postfix inc/dec expr"); // /home/ionut/workspace/Development/Zig/heart/include/lua/lauxlib.h:209:9
pub const luaL_addsize = @compileError("unable to translate C expr: expected ')' instead got '+='"); // /home/ionut/workspace/Development/Zig/heart/include/lua/lauxlib.h:213:9
pub const luaL_buffsub = @compileError("unable to translate C expr: expected ')' instead got '-='"); // /home/ionut/workspace/Development/Zig/heart/include/lua/lauxlib.h:215:9
...
pub const LUA_GK = @as(c_int, 1);
pub const LUA_LOADLIBNAME = "package";
pub const LUA_LOADLIBK = LUA_GK << @as(c_int, 1);
...
pub inline fn luaL_openlibs(L: anytype) @TypeOf(luaL_openselectedlibs(L, ~@as(c_int, 0))) {
    return luaL_openselectedlibs(L, ~@as(c_int, 0));
}
pub const lauxlib_h = "";
